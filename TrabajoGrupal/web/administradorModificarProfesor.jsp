    ...
    <div class="content-wrapper py-3">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-table"></i> MODIFICAR PROFESIONAL
			         <div class="content-wrapper py-3">
					 <form action="" class="">
                ...
                <div class="card-block">
                    <div class="table-responsive">
					  ...
					  <input class="form-control" id="nombre" type="text" placeholder="Codigo:">
					 ...
					 <input class="form-control" id="" type="text" placeholder="Elige:">
					  ...
					  <button class="btn btn-primary" >Modificar PROFESIONAL</button>
